package com.koki.book.book;

import com.koki.book.common.PageResponse;
import com.koki.book.exception.OperationNotPermittedException;
import com.koki.book.file.FileStorageService;
import com.koki.book.history.BookTransactionHistory;
import com.koki.book.history.BookTransactionHistoryRepository;
...
public class BookService {
    ...
    public Integer returnBorrowedBook(Integer bookId, Authentication connectedUser) {
        ...
        User user=((User)connectedUser.getPrincipal());
        if (Objects.equals(book.getOwner().getId(), user.getId())) {
            throw new OperationNotPermittedException("You can not borrow or returned your own book");
        }
    ...
    public Integer approveReturnBorrowedBook(Integer bookId, Authentication connectedUser) {
        ...
        User user=((User)connectedUser.getPrincipal());
        if (!Objects.equals(book.getOwner().getId(), user.getId())) {
            throw new OperationNotPermittedException("You cannot approve the  book you do not own");
        }
